...
const handleSignup = async () => {
  ...
  <ScrollView style={{ flex: 1 }} automaticallyAdjustKeyboardInsets>
    ...
    {/* === Terms Modal === */}
    <Modal animationIn="fadeIn" animationOut="fadeOut" isVisible={modalVisible} backdropColor="#000" backdropOpacity={0.1}  onBackdropPress={() => setModalVisible(false)} style={{alignItems: "center", justifyContent: "center"}}>
    ...
    >
      <TouchableOpacity style={[styles.button, { backgroundColor: '#00505cff' }]} onPress={() => setModalVisible(true)} >
     ...
     <Modal animationIn="fadeIn" animationOut="fadeOut" isVisible={signUpSuccess} backdropColor="#000" backdropOpacity={0.5} onBackdropPress={() => setSignUpSucess(false)} style={{ alignItems: "center", justifyContent: "center" }} >
        ...
        >
          ...
          <Text style={{ fontSize: 20, fontWeight: "bold", color: "#22c55e", textAlign: "center", marginBottom: 10, }} > Sign Up Successful! </Text>
